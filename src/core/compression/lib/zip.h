...
extern ZIP_EXPORT const char *zip_lasterror(struct zip_t *zip); 
// extern ZIP_EXPORT void zip_set_last_error(struct zip_t *zip, mz_zip_error err_num);
extern struct zip_t *zip_mem_new(void *data, size_t size);
